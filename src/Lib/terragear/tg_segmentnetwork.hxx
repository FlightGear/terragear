...
typedef CGAL::Simple_cartesian<double>                      nodesKernel;
typedef nodesKernel::Point_2                                nodesPoint;
typedef boost::tuple<nodesPoint,segnetVertexHandle>         nodesPointHandle;

typedef CGAL::Search_traits_2<nodesKernel>                  nodesTraitsBase;
