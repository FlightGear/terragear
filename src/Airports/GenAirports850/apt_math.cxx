                          ...
                          bool   add_mid )
{
    ...
    std::vector<cgalPoly_Point> points;
    SGGeod pt;
    ...
    pt = SGGeodesy::direct( ref, left_hdg, -width_m / 2.0);
    points.push_back( cgalPoly_Point(pt.getLongitudeDeg(), pt.getLatitudeDeg()) );
    ...
    if ( add_mid ) {
        ...
        pt = SGGeodesy::direct( origin, left_hdg, width_m / 2.0 );
        points.push_back( cgalPoly_Point(pt.getLongitudeDeg(), pt.getLatitudeDeg()) );
    }
    ...
    return cgalPoly_Polygon( points.begin(), points.end() );
}
                          ...
                          bool   add_mid )
{
    ...
    if ( add_mid ) {
        ...
        pt = SGGeodesy::direct( center, left_hdg, width_m / 2.0 );
        points.push_back( cgalPoly_Point(pt.getLongitudeDeg(), pt.getLatitudeDeg()) );
    }
...
cgalPoly_Polygon gen_wgs84_rect( SGGeod origin, double heading, double length, double width )
{
    ...
    points.push_back( cgalPoly_Point(p.getLongitudeDeg(), p.getLatitudeDeg()) );
